...
export { default as ApproveMerchant } from "./dashboard/admin/ticket/approve-merchant";
export { default as Tickets } from "./dashboard/admin/ticket/tickets";
export { default as UnresolvedTickets } from "./dashboard/admin/ticket/unresolved-tickets";
export { default as ResolvedTickets } from "./dashboard/admin/ticket/resolved-tickets";
