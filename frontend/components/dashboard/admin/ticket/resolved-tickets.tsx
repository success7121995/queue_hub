...
const ResolvedTickets = () => {
	...
	const { data: ticketsResponse, isLoading } = useGetAllTickets("RESOLVED", {
		staleTime: 0,
		gcTime: 0,
	});
		...
		return (
			<div className="min-h-screen font-regular-eng p-8">
				<div className="flex justify-between items-center mb-8">
					<h1 className="text-3xl text-primary-light font-bold">Resolved Tickets</h1>
				</div>
				<LoadingIndicator />
			</div>
		);
	...
	return (
		<div className="min-h-screen font-regular-eng p-8">
			<div className="flex justify-between items-center mb-8">
				<h1 className="text-3xl text-primary-light font-bold">Resolved Tickets</h1>
				<ExportBtn data={tickets} filename="resolved-tickets" />
			</div>
