...
exports.uploadChatAttachment = exports.uploadTicketFiles = exports.uploadAvatar = exports.uploadGalleries = exports.uploadFeatureImage = exports.uploadLogo = void 0;
...
const fileFilter = (req, file, cb, acceptPDF = false) => {
    const allowedTypes = [
        'image/jpeg',
        'image/png',
        'image/webp',
...
exports.uploadTicketFiles = (0, multer_1.default)({ storage, fileFilter, limits }).array('FILES', 10);
exports.uploadChatAttachment = (0, multer_1.default)({ storage, fileFilter, limits }).single('ATTACHMENT');
