 ...
 */
export const checkUserExists = async (email: string, username: string, phone?: string): Promise<boolean> => {
 ...
 */
export const validatePasswords = (password: string, confirm_password: string): void => {
